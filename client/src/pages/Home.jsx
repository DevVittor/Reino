          ...
          <div className="flex justify-center relative h-full items-center">
            <div className="w-[320px] absolute bottom-0 sm:top-1/2 sm:bottom-auto sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 max-h-[500px] overflow-hidden bg-white rounded-2xl shadow-xl p-4 flex flex-col gap-3 border border-zinc-200 transition-all ease-in-out duration-150">
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg border border-zinc-200 bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                value={searchTerm}
              ...
              <select
                ...
                className="w-full px-4 py-2 rounded-lg border border-zinc-200 bg-zinc-50 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                      ...
                      <div className="ml-5 mt-1">
                        {getSubcategoriesForCategory(category._id).map(
                          (sub) => (
                            <label
                              key={sub._id}
                              className="flex items-center gap-2 text-sm text-zinc-600 hover:text-blue-500 mb-1"
                            >
                              <input
                                type="checkbox"
                                className="accent-blue-600 w-4 h-4"
              ...
              <button
                className="w-full bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold py-2 rounded-lg hover:opacity-90 transition-all text-sm"
                onClick={() => {
                  fetchProducts();
                  setModalSearch(false);
                }}
